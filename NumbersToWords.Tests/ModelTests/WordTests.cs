...
namespace NumbersToWords.Tests
{
  ...
  public class WordTests // : IDisposable
  {
    ...
    [TestMethod]
    public void WholeNumToWord_ReturnWholeNumberWords_ThreeHundredBillionSevenHundredTenMillionTwoHundredThirtyFourThousandFiveHundred()
    {
      string numStr = "300710204511";
      string word = Word.WholeNumToWord(numStr);
      Assert.AreEqual("Three Hundred Billion Seven Hundred Ten Million Two Hundred Four Thousand Five Hundred Eleven", word);
    }
  }
}